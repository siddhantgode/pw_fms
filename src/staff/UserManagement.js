    ...
    <div className="container mt-4">
      ...
      <div className="row justify-content-center" style={{ gap: '20px' }}>
        <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-3">
          <div
            className={`tile ${activeCategory === 'Staff' ? 'bg-primary text-white' : ''}`}
            ...
            style={{
              ...
              borderRadius: '4px',
              backgroundColor: activeCategory === 'Staff' ? '#007bff' : '#f9f9f9',
            }}
          >
            <FontAwesomeIcon icon={faUsers} size="lg" style={{ marginBottom: '5px', color: activeCategory === 'Staff' ? '#fff' : '#007bff' }} />
            <span>Staff</span>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-3">
          <div
            className={`tile ${activeCategory === 'Drivers' ? 'bg-primary text-white' : ''}`}
            ...
            style={{
              ...
              border: '1px solid #ddd',
              borderRadius: '4px',
              backgroundColor: activeCategory === 'Drivers' ? '#007bff' : '#f9f9f9',
            }}
          >
            <FontAwesomeIcon icon={faTruck} size="lg" style={{ marginBottom: '5px', color: activeCategory === 'Drivers' ? '#fff' : '#007bff' }} />
            <span>Drivers</span>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-3">
          <div
            className={`tile ${activeCategory === 'Vendors' ? 'bg-primary text-white' : ''}`}
            ...
            style={{
              ...
              border: '1px solid #ddd',
              borderRadius: '4px',
              backgroundColor: activeCategory === 'Vendors' ? '#007bff' : '#f9f9f9',
            }}
          >
            <FontAwesomeIcon icon={faStore} size="lg" style={{ marginBottom: '5px', color: activeCategory === 'Vendors' ? '#fff' : '#007bff' }} />
            <span>Vendors</span>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-3">
          <div
            className={`tile ${activeCategory === 'Support' ? 'bg-primary text-white' : ''}`}
            ...
            style={{
              ...
              border: '1px solid #ddd',
              borderRadius: '4px',
              backgroundColor: activeCategory === 'Support' ? '#007bff' : '#f9f9f9',
            }}
          >
            <FontAwesomeIcon icon={faHeadset} size="lg" style={{ marginBottom: '5px', color: activeCategory === 'Support' ? '#fff' : '#007bff' }} />
            <span>Support</span>
          </div>
        </div>
        <div className="col-12 col-sm-6 col-md-4 col-lg-2 mb-3">
          <div
            className={`tile ${activeCategory === 'Important' ? 'bg-primary text-white' : ''}`}
            ...
            style={{
              ...
              border: '1px solid #ddd',
              borderRadius: '4px',
              backgroundColor: activeCategory === 'Important' ? '#007bff' : '#f9f9f9',
            }}
          >
            <FontAwesomeIcon icon={faStar} size="lg" style={{ marginBottom: '5px', color: activeCategory === 'Important' ? '#fff' : '#007bff' }} />
            <span>Important</span>
          </div>
        </div>
      </div>
